                    ...
                    stages{
                        ...
                        stage("Tests"){
                            ...
                            stages{
                                stage("Dr memory"){
                                    steps{
                                        sh(script: '''cmake -B ./build/drmem -DCMAKE_C_FLAGS="-fno-inline -fno-omit-frame-pointer -fprofile-arcs -ftest-coverage" -DCMAKE_CXX_FLAGS="-fno-inline -fno-omit-frame-pointer -fprofile-arcs -ftest-coverage" -DCMAKE_EXE_LINKER_FLAGS="-fprofile-arcs -ftest-coverage"
