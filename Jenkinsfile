                                        ...
                                        catchError(buildResult: "UNSTABLE", message: 'Did not pass all pytest tests', stageResult: "UNSTABLE") {
                                            sh(
                                                script: '''mkdir -p logs
                                                           ...
                                                           coverage run  --parallel python setup.py test --addopts "--junitxml=reports/pytest-junit.xml"
